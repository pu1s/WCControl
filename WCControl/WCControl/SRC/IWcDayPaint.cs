...
namespace WCControl
{
    public interface IWcDayPaint
    {
        
        void DrawBg(Graphics gfx, UserControl control);
        void DrawDate(Graphics gfx, UserControl control);
        void DrawMarker(Graphics gfx, UserControl control);
    }
}
